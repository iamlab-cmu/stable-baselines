...
from stable_baselines_custom.common.policies import BasePolicy, nature_cnn, register_policy
from stable_baselines_custom.common.tf_layers import mlp
...
class FeedForwardPolicy(SACPolicy):
    ...
    def make_actor(self, obs=None, reuse=False, scope="pi"):
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            # the std depends on the state, so we cannot use stable_baselines_custom.common.distribution
